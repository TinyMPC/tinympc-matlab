...
extern "C"{
    ...
    void call_tiny_solve(){
        ...
        std::cout << "tiny solve finished" << exitflag<<std::endl;
    }
    ...
    Eigen::Map<tiny_MatrixNxNx>(A_dyn, tiny_data_solver.work->Adyn.rows(), tiny_data_solver.work->Adyn.cols()) = tiny_data_solver.work->Adyn;
    }

    void get_Bdyn(float *B_dyn){
    Eigen::Map<tiny_MatrixNxNu>(B_dyn, tiny_data_solver.work->Bdyn.rows(), tiny_data_solver.work->Bdyn.cols()) = tiny_data_solver.work->Bdyn;
    }
